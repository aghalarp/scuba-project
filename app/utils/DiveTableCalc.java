...
public class DiveTableCalc {
    ...
    public Map<Integer, SingleDiveData> diveResultsMap = new LinkedHashMap<Integer, SingleDiveData>();

    //Each nested list contains, in order: depth, time, SIT, TNT, endOfDivePG, decompressionTime, postSIT-PG
    public Map<Integer, List<String>> plainResultsMap = new HashMap<Integer, List<String>>();
    ...
    //If error found, this will hold the FIRST error message that occurred.
    ...
    public static void main(String[] args) {
        ...
        DiveTableCalc dt = new DiveTableCalc();
        dt.calculateDiveTableResults(testDives);
        System.out.println(dt);
        System.out.println("Error Vars Check: " + dt.errorFound + ": " + dt.errorMessage);
        ...
        testDives2.add(110);
        testDives2.add(50);
        testDives2.add(62); //63 results in null pointer because of table 1 lookup. Fix.
        testDives2.add(52);
        testDives2.add(10);
        testDives2.add(11);
        testDives2.add(12);

        DiveTableCalc dt2 = new DiveTableCalc();
        dt2.calculateDiveTableResults(testDives2);
        System.out.println(dt2);
        System.out.println("Error Vars Check: " + dt2.errorFound + ": " + dt2.errorMessage);

        //Illegal Dive 2
        System.out.println("\n\nIllegal dive test 2");
        List<Integer> testDives3 = new ArrayList<Integer>();
        testDives3.add(100);
        testDives3.add(30);
        testDives3.add(20);
        //testDives3.add(40);
        ...
        DiveTableCalc dt3 = new DiveTableCalc();
        dt3.calculateDiveTableResults(testDives3);
        System.out.println(dt3);
        System.out.println("Error Vars Check: " + dt3.errorFound + ": " + dt3.errorMessage);
    }
    ...
    public DiveTableCalc() {
        ...
        rowJMap.put(50, new Integer[]{87, 0});
...
//            System.out.println("Dive #" + diveNumber + ", Depth: " + diveDepth + ", Time: " + diveTime + ", Surface Interval Time: " + surfaceIntervalTime);
            ...
            if (i != 0) {
                ...
                if(diveTime > tableThreeResult[1]) {
                    ...
                    this.errorMessage = "Dive Time is greater than allowed Adjusted Maximum Dive Time."; //Set error message instance variable.
                }
...
//            System.out.println("\tPost-Surface-Interval-Time Pressure Group: " + currentPressureGroup);
    ...
    /**
     * Method to create a version of diveResultsMap that contains <Integer, List> instead of <Integer, SingleDiveData>
     * Just need to call once per instance.
     */
    public void createPlainResultsMap () {
        for (Map.Entry<Integer, SingleDiveData> entry : this.diveResultsMap.entrySet()) {
            Integer diveNumber = entry.getKey();
            SingleDiveData diveData = entry.getValue();

            List<String> diveEntry = new ArrayList<String>();
            diveEntry.add(Integer.toString(diveData.diveDepth));
            diveEntry.add(Integer.toString(diveData.diveTime));
            diveEntry.add(Integer.toString(diveData.surfaceIntervalTime));
            diveEntry.add(Integer.toString(diveData.totalNitrogenTime));
            diveEntry.add(diveData.endOfDivePG);
            diveEntry.add(Integer.toString(diveData.decompressionTime));
            diveEntry.add(diveData.postSurfaceIntervalPG);

            this.plainResultsMap.put(diveNumber, diveEntry);
        }
    }
}
